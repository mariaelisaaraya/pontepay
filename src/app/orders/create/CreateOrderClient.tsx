    ...
    return (
      <FadeIn>
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          <p className="font-display text-xl font-semibold text-amber-900">Conecta tu wallet primero</p>
          <p className="mt-2 text-sm text-amber-800">
            Necesitas una wallet Stellar activa para crear órdenes. Sin extensión, solo email.
          </p>
          <Button
            type="button"
